class App.PublicLink extends App.Model
  ...
  @description = __('''
You can define links which are shown e.g. in the footer of EchoDesk's login screen. These have many purposes, such as displaying a data privacy page for all people using your EchoDesk instance.
''')
